  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900 flex flex-col md:flex-row">
      ...
      <aside className="hidden md:flex w-64 bg-white border-r border-slate-200 flex-col justify-between h-screen sticky top-0">
        <div>
          <div className="px-6 py-5 flex items-center space-x-2 border-b border-slate-200">
      ...
      <main className="flex-1 flex flex-col min-h-screen md:h-screen md:overflow-y-auto relative">
        ...
        <header className="md:hidden flex items-center justify-between px-4 py-3 bg-white border-b border-slate-200 sticky top-0 z-40">
          <div className="flex items-center space-x-2">
            <Zap className="h-5 w-5 text-blue-600 fill-blue-100" />
            <span className="font-display font-bold text-lg text-slate-800">BillingApp</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="flex-1">
              ...
              <select
                ...
                className="w-full bg-white border border-slate-300 rounded-lg px-3 py-2 text-sm text-slate-800 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 font-medium cursor-pointer"
              >
